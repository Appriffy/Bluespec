...
/* harmony import */ var _companies_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./companies.page */ "./src/app/companies/listing/companies.page.ts");
/* harmony import */ var _companies_resolver__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../companies.resolver */ "./src/app/companies/companies.resolver.ts");
/* harmony import */ var _companies_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../companies.service */ "./src/app/companies/companies.service.ts");
...
/* harmony import */ var _company_filter_company_filter_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./company-filter/company-filter.page */ "./src/app/companies/listing/company-filter/company-filter.page.ts");
/* harmony import */ var _bluspec_recruiter_location_autocomplete_location_autocomplete_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../bluspec-recruiter/location-autocomplete/location-autocomplete.page */ "./src/app/bluspec-recruiter/location-autocomplete/location-autocomplete.page.ts");
/* harmony import */ var _bluspec_recruiter_location_autocomplete_location_autocomplete_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../bluspec-recruiter/location-autocomplete/location-autocomplete.module */ "./src/app/bluspec-recruiter/location-autocomplete/location-autocomplete.module.ts");
...
CompaniesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _bluspec_recruiter_location_autocomplete_location_autocomplete_module__WEBPACK_IMPORTED_MODULE_12__["LocationAutocompletePageModule"],
        ...
        providers: [
            _companies_resolver__WEBPACK_IMPORTED_MODULE_7__["CompanyListingResolver"],
            _companies_service__WEBPACK_IMPORTED_MODULE_8__["CompanyService"]
        ],
...
/* harmony import */ var _company_filter_company_filter_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./company-filter/company-filter.page */ "./src/app/companies/listing/company-filter/company-filter.page.ts");
...
let CompaniesPage = class CompaniesPage {
    ...
    ngOnInit() {
        ...
        //this.fetchCompanies();
        this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_8__["AuthConstants"].COMPANIES).then(companies => {
            if (companies) {
...
CompaniesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./companies.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/companies/listing/companies.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/listing.page.scss */ "./src/app/companies/listing/styles/listing.page.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/listing.shell.scss */ "./src/app/companies/listing/styles/listing.shell.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/company-listing.ios.scss */ "./src/app/companies/listing/styles/company-listing.ios.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ../../bluspecstyles/listing.page.scss */ "./src/app/bluspecstyles/listing.page.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CompanyFilterPage", function() { return CompanyFilterPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _components_counter_input_counter_input_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../components/counter-input/counter-input.component */ "./src/app/components/counter-input/counter-input.component.ts");
...
let CompanyFilterPage = class CompanyFilterPage {
    constructor(storageService, formBuilder, masterService, modalController, dealsService, toaster) {
        this.storageService = storageService;
        ...
        this.masterService.getJobAreas().subscribe((res) => {
            if (!res.error) {
                ...
                this.skill_types.map((item) => {
                    this.validationsForm.controls.skills.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]());
                });
            }
        }, (error) => {
            alert('Looks like there is a Network Issue while fetching skills.');
    ...
    getCurrentPosition() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const isAvailable = _capacitor_core__WEBPACK_IMPORTED_MODULE_8__["Capacitor"].isPluginAvailable('Geolocation');
            if (!isAvailable) {
                console.log('Err: plugin not available');
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["of"])(new Error('Err: plugin not available'));
            }
            const POSITION = _capacitor_core__WEBPACK_IMPORTED_MODULE_8__["Plugins"].Geolocation.getCurrentPosition()
...
CompanyFilterPage.ctorParameters = () => [
...
CompanyFilterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-company-filter',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./company-filter.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/companies/listing/company-filter/company-filter.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./company-filter.page.scss */ "./src/app/companies/listing/company-filter/company-filter.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_storage_service__WEBPACK_IMPORTED_MODULE_6__["StorageService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
        _services_master_service__WEBPACK_IMPORTED_MODULE_4__["MasterService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ModalController"],
...
//# sourceMappingURL=listing-companies-module-es2015.js.map