...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["welcome-welcome-welcome-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppWelcomeWelcomeWelcomePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppWelcomeWelcomeWelcomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _app_masters_job_skills_job_skills_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../app-masters/job-skills/job-skills.service */
  ...
  /***/
  function srcAppWelcomeWelcomeWelcomePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppWelcomeWelcomeWelcomePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _app_masters_job_skills_job_skills_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../app-masters/job-skills/job-skills.service */
    "./src/app/app-masters/job-skills/job-skills.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function WelcomePage(firebaseService, masterService, authService, storageService, alertController, modalController, router, toastService, menu, route) {
      ...
      _createClass(WelcomePage, [{
        key: "getCompaniesOnBoard",
        value: function getCompaniesOnBoard() {
          var _this = this;

          /******** START FETCH COMPANIES *******/
          this.masterService.getCompanyListCarosell(this.api_key).subscribe(function (res) {
            if (res) {
              _this.storageService.store(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].COMPANIES, res.items);

              console.log("FETCHED COMPANIES : " + JSON.stringify(res));
              _this.companies = res.items;
            }
          }, function (error) {
            _this.toastService.presentToast('Looks like there is a Network Issue while fetching companies.');
          });
        ...
        value: function ngOnInit() {
          ...
          this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].AUTH).then(function (res) {
            if (res) {
              _this2.localUser = res;
              _this2.isLoggedIn = true;
              _this2.api_key = res.api_key;

              if (_this2.localUser != null && _this2.localUser.role_id == 2) {
                _this2.employerMode = true;
              }

              _this2.getJobAreasFromLocalStorage();

              _this2.getJobSkillsFromLocalStorage();

              _this2.getCompaniesFromLocalStorage(); //This is live fetch mode instead
              //this.getJobSkillsOnBoard();
              //this.getJobAreasOnBoard();
              //this.getCompaniesOnBoard();


              _this2.toastService.presentToast("Bluspec is on your board.  " + _this2.api_key);
            } else {
        ...
        key: "getJobSkillsOnBoard",
        value: function getJobSkillsOnBoard() {
          var _this3 = this;
          ...
          this.masterService.getSkills().subscribe(function (res) {
            if (!res.error) {
              ...
              _this3.skills = res.result;

              _this3.storageService.store(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].JOB_SKILLS, res.result);
            }
          }, function (error) {
            _this3.toastService.presentToast('Looks like there is a Network Issue while fetching skills.');
          });
          /******** ENDS FETCH SKILLS THEN *******/
        }
      }, {
        key: "getJobAreasOnBoard",
        value: function getJobAreasOnBoard() {
          var _this4 = this;
          ...
          this.masterService.getJobAreas().subscribe(function (res) {
            if (!res.error) {
              ...
              _this4.jobAreas = res.result;

              _this4.storageService.store(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].JOB_CATEGORIES, res.result);
            }
          }, function (error) {
            _this4.toastService.presentToast('Looks like there is a Network Issue while fetching job areas.');
          });
        ...
        key: "getCompaniesFromLocalStorage",
        value: function getCompaniesFromLocalStorage() {
          var _this5 = this;

          this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].COMPANIES).then(function (results) {
            if (results) {
              _this5.companies = results;
            } else {
              if (_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].DEV_MODE) {
                _this5.toastService.presentToast("Fetching companies from server.");
              }

              _this5.getCompaniesOnBoard();
            }
          });
        }
      }, {
        key: "getJobSkillsFromLocalStorage",
        value: function getJobSkillsFromLocalStorage() {
          var _this6 = this;

          this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].JOB_SKILLS).then(function (results) {
            if (results) {
              _this6.skills = results;
            } else {
              if (_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].DEV_MODE) {
                _this6.toastService.presentToast("Fetching job skills from server.");
              }

              _this6.getJobSkillsOnBoard();
            }
          });
        }
      }, {
        key: "getJobAreasFromLocalStorage",
        value: function getJobAreasFromLocalStorage() {
          var _this7 = this;

          this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].JOB_AREAS).then(function (results) {
            if (results) {
              _this7.jobAreas = results;
            } else {
              if (_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].DEV_MODE) {
                _this7.toastService.presentToast("Fetching Job Areas from server.");
              }

              _this7.getJobAreasOnBoard();
            }
          });
        }
      }]);
    ...
    WelcomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/welcome/welcome/welcome.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./welcome.page.scss */
      "./src/app/welcome/welcome/welcome.page.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_masters_job_skills_job_skills_service__WEBPACK_IMPORTED_MODULE_2__["JobSkillsService"], _services_master_service__WEBPACK_IMPORTED_MODULE_5__["MasterService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _services_storage_service__WEBPACK_IMPORTED_MODULE_8__["StorageService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _services_toast_service__WEBPACK_IMPORTED_MODULE_6__["ToastService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["MenuController"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])], WelcomePage);
    /***/
  }
}]);
//# sourceMappingURL=welcome-welcome-welcome-module-es5.js.map