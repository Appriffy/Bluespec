...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobFilterPage", function() { return JobFilterPage; });
...
/* harmony import */ var _bluspec_recruiter_location_autocomplete_location_autocomplete_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../bluspec-recruiter/location-autocomplete/location-autocomplete.page */ "./src/app/bluspec-recruiter/location-autocomplete/location-autocomplete.page.ts");
...
let JobFilterPage = class JobFilterPage {
    constructor(formBuilder, storageService, authService, jobService, modalCtrl, modalController) {
    ...
    ngOnInit() {
        ...
        this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_5__["AuthConstants"].JOB_TYPES).then(results => {
            if (results) {
                ...
                this.job_types.map((item) => {
                    this.userFilterForm.controls.jobTypes.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]());
        ...
        this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_5__["AuthConstants"].JOB_SKILLS).then(results => {
            if (results) {
                ...
                this.skill_types.map((item) => {
                    this.userFilterForm.controls.skillID.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]());
                    //(this.userFilterForm.controls.skillID as FormArray).push(this.formBuilder.group(new FormControl()));
                });
                this.skill_types.map((item) => {
                    this.userFilterForm.controls.availableJobTypes.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]());
                });
                /*********Start the Restore
    ...
    onJobSkillsChange(event, id) {
        if (event.target.checked) {
            this.selected_skills.push(id);
        }
        else {
            const index = this.selected_skills.indexOf(id);
            if (index !== -1) {
    ...
    onJobTypeFilterSelected(event, id) {
        console.log("#####: onJobTypeFilterSelected " + id);
        if (event.target.checked) {
            this.selected_job_types.push(id);
        }
        else {
            const index = this.selected_job_types.indexOf(id);
            if (index !== -1) {
    ...
    get skillsFormArray() { return this.userFilterForm.get('skillID'); }
    get jobTypesFormArray() { return this.userFilterForm.get('jobTypes'); }
    updateSkillTypes() {
        this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_5__["AuthConstants"].JOB_SKILLS).then(allList => {
            if (allList) {
                allList.map((item) => {
                    item.enabled = 0;
                });
...
JobFilterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-job-filter',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./job-filter.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/jobs/listing/job-filter/job-filter.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./job-filter.page.scss */ "./src/app/jobs/listing/job-filter/job-filter.page.scss")).default]
    }),
...
//# sourceMappingURL=default~jobs-listing-job-filter-job-filter-module~jobs-listing-jobs-listing-module-es2015.js.map