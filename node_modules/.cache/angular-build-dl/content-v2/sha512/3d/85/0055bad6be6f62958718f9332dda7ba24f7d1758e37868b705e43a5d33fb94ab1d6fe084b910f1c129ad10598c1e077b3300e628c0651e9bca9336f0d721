...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~documents-upload-document-upload-document-module~user-documents-upload-document-upload-docum~05c5089d"], {
  ...
  function srcAppUserDocumentsUploadDocumentUploadDocumentPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(UploadDocumentPage, [{
        ...
        value: function uploadBinaryFile(event) {
          ...
          var file = this.myFileInput.nativeElement.files[0];
          ...
          this.uploadFileForm.get('document').updateValueAndValidity(); //console.log("uploadFile() "+this.uploadFileForm.value);
          // File Preview
          ...
          reader.onload = function () {
            ...
            _this4.localFileSrc = reader.result;
          ...
          reader.readAsDataURL(file); //this.localFileSrc = reader.readAsArrayBuffer(file);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('fileInput', {
      static: false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])], UploadDocumentPage.prototype, "myFileInput", void 0);
