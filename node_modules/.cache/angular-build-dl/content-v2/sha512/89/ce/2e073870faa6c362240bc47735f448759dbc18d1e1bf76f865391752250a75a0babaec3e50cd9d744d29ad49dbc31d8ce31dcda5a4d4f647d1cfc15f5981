...
/* harmony import */ var _dbmodels_settings_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../dbmodels/settings-model */ "./src/app/dbmodels/settings-model.ts");
...
let SettingsPage = class SettingsPage {
    constructor(authService, storageService, loadingController, router) {
    ...
    ngOnInit() {
        ...
        this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_7__["AuthConstants"].APP_SETTINGS).then(appSettings => {
            if (appSettings) {
                ...
                this.settingsModel = new _dbmodels_settings_model__WEBPACK_IMPORTED_MODULE_3__["SettingsModel"]();
            }
...
SettingsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ../bluspecstyles/filter.page.scss */ "./src/app/bluspecstyles/filter.page.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./settings.page.scss */ "./src/app/settings/settings.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"],
        ...
        _services_loading_service_service__WEBPACK_IMPORTED_MODULE_8__["LoadingServiceService"],
