...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-verify-account-verify-account-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSignupVerifyAccountVerifyAccountPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSignupVerifyAccountVerifyAccountModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "VerifyAccountPageModule", function () {
    ...
    var _verify_account_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./verify-account.page */
    ...
    var VerifyAccountPageModule = function VerifyAccountPageModule() {
      _classCallCheck(this, VerifyAccountPageModule);
    };

    VerifyAccountPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppSignupVerifyAccountVerifyAccountPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSignupVerifyAccountVerifyAccountPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "VerifyAccountPage", function () {
    ...
    var _registration_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../registration.service */
    "./src/app/signup/registration.service.ts");

    var VerifyAccountPage =
    /*#__PURE__*/
    function () {
      function VerifyAccountPage(router, activatedRoute, menu, loadingController, alertController, registrationService) {
        _classCallCheck(this, VerifyAccountPage);
      ...
      _createClass(VerifyAccountPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.registrationService.getCachedData().then(function (res) {
            if (res) {
              ...
              //this.prevStep();
              _this.presentAlert("INVALID SESSION", "", "Looks like something went wrong and we could not identify you. Please close this app and start again..");
            }
          });
        }
      }, {
    ...
    VerifyAccountPage.ctorParameters = function () {
      return [{
    ...
    VerifyAccountPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-verify-account',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./verify-account.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/signup/verify-account/verify-account.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./verify-account.page.scss */
      "./src/app/signup/verify-account/verify-account.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["MenuController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], _registration_service__WEBPACK_IMPORTED_MODULE_5__["RegistrationService"]])], VerifyAccountPage);
    /***/
  }
}]);
//# sourceMappingURL=signup-verify-account-verify-account-module-es5.js.map