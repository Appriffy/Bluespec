...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[75], {
  ...
  function node_modulesIonicCoreDistEsmIonToastMdEntryJs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(Toast, [{
          ...
          return regeneratorRuntime.async(function present$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return regeneratorRuntime.awrap(Object(_chunk_d83bfeae_js__WEBPACK_IMPORTED_MODULE_2__["d"])(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position));
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  _context3.prev = 1;
                  _context3.next = 4;
                  return regeneratorRuntime.awrap(Object(_chunk_d83bfeae_js__WEBPACK_IMPORTED_MODULE_2__["s"])(button.handler));
        ...
        value: function render() {
          ...
          return Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["H"], {
            ...
            class: Object.assign(_defineProperty({}, mode, true), Object(_chunk_353a032e_js__WEBPACK_IMPORTED_MODULE_3__["c"])(this.color), Object(_chunk_353a032e_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.cssClass), {
    ...
    var buttonClass = function buttonClass(button) {
      ...
      }, _defineProperty(_Object$assign2, "toast-button-".concat(button.role), button.role !== undefined), _defineProperty(_Object$assign2, 'ion-focusable', true), _defineProperty(_Object$assign2, 'ion-activatable', true), _Object$assign2), Object(_chunk_353a032e_js__WEBPACK_IMPORTED_MODULE_3__["g"])(button.cssClass));
    };
    /***/
