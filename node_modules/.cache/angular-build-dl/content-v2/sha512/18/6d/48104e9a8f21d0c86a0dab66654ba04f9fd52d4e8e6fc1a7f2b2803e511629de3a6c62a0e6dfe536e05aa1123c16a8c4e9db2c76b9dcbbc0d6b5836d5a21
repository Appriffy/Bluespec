...
let NotificationsPage = class NotificationsPage {
    constructor(route, menu, authService, toastService, notiService) {
        this.route = route;
        this.menu = menu;
    ...
    loadItems() {
        this.loading = true;
        this.notiService.getData(this.localUser.api_key).subscribe((res) => {
            if (!res.error) {
...
NotificationsResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_notifications_service__WEBPACK_IMPORTED_MODULE_2__["NotificationsService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])
...
let NotificationsService = class NotificationsService {
    ...
    getData(api_key) {
        ...
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + apiUrl;
