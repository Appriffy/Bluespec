...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["update-user-update-user-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserUpdateUserUpdateUserProfileModalHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserUpdateUserStylesUpdateUserModalScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserUpdateUserStylesUpdateUserShellScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserUpdateUserUpdateUserProfileModalTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UpdateUserProfileModal", function () {
    ...
    var UpdateUserProfileModal =
    /*#__PURE__*/
    function () {
      function UpdateUserProfileModal(modalController, alertController, firebaseService, masterService, authService, utilsService, activatedRoute, toastService, loadingController, storageService, route, router) {
        _classCallCheck(this, UpdateUserProfileModal);
      ...
      _createClass(UpdateUserProfileModal, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function (params) {
            if (params.get("user_id")) {
              var user_profile_id = params.get("user_id");

              _this.authService.getAuthCache().then(function (result) {
                _this.localUser = result;

                _this.firebaseService.getProfileDataSource(_this.localUser.api_key, user_profile_id).subscribe(function (res) {
                  ...
                  if (!res.error) {
                    _this.user = res.myProfile;

                    if (_config_AuthConstants__WEBPACK_IMPORTED_MODULE_9__["AuthConstants"].DEV_MODE) {
                      console.log("PROFILE UPDATE SYNC => " + JSON.stringify(_this.user));
                    }

                    if (user_profile_id != _this.localUser.user_name) {//this.selfView = false;
                    }

                    if (_this.localUser.id !== _this.user.id) {
                      _this.moderateMode = true;
                    } // this.loading = false;
                  ...
                  _this.toastService.presentToast('Looks like there is a Network Issue while fetching profile.');
                });
              });
            } else {}
          });
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          _this2.firebaseService.deleteItem(_this2.localUser.api_key, postData).subscribe(function (res) {
                            ...
                            if (res.error) {
                              ...
                              //   });
                              _this2.dismissModal(); //console.log('Modal Dismiss Time 007 # '+JSON.stringify(this.deleteResult));


                              _this2.toastService.presentToast(res.message);

                              _this2.router.navigate(['/hire-people-for-work']);
                            }
                          }, function (error) {
                            _this2.loadingController.dismiss();
        ...
        value: function updateUser() {
          ...
          this.firebaseService.callUpdateAPI(this.localUser.api_key, postData).subscribe(function (res) {
            _this3.loadingController.dismiss(); //alert(JSON.stringify(res));
            ...
            if (!res.error) {
              ...
              if (res.user_name) {
                _this3.router.navigate(['/people/details', res.user_name]);
              } else {
                _this3.router.navigate(['/people/profile']);
        ...
        value: function uploadFile(event) {
          ...
          reader.onload = function () {
            _this4.updatedImage = reader.result;
            _this4.user.user_image = _this4.updatedImage;
          };
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (item) {
                      if (item.data != null) {
                        ...
                        _this5.updateUserForm.controls.country.patchValue(item.data);
                      }
                    });
                    _context2.next = 6;
    ...
    UpdateUserProfileModal.ctorParameters = function () {
      return [{
    ...
    UpdateUserProfileModal = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-update-user-profile',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./update-user-profile.modal.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user/update-user/update-user-profile.modal.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./styles/update-user.modal.scss */
      "./src/app/user/update-user/styles/update-user.modal.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./styles/update-user.shell.scss */
      "./src/app/user/update-user/styles/update-user.shell.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _user_service__WEBPACK_IMPORTED_MODULE_8__["UserService"], _services_master_service__WEBPACK_IMPORTED_MODULE_5__["MasterService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _services_utils_service__WEBPACK_IMPORTED_MODULE_11__["UtilsService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _services_toast_service__WEBPACK_IMPORTED_MODULE_6__["ToastService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _services_storage_service__WEBPACK_IMPORTED_MODULE_10__["StorageService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], UpdateUserProfileModal);
    /***/
  },
  ...
  /***/
  function srcAppUserUpdateUserUpdateUserModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _update_user_profile_modal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
