...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProfessionalProfilePageModule", function() { return ProfessionalProfilePageModule; });
...
/* harmony import */ var _professional_profile_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./professional-profile.page */ "./src/app/signup/professional-profile/professional-profile.page.ts");
...
let ProfessionalProfilePageModule = class ProfessionalProfilePageModule {
};
ProfessionalProfilePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProfessionalProfilePage", function() { return ProfessionalProfilePage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let ProfessionalProfilePage = class ProfessionalProfilePage {
    constructor(masterService, userService, router, navCtrl, activatedRoute, menu, registrationService, storageService) {
        ...
        this.masterService.getJobAreas().subscribe((res) => {
            if (!res.error) {
                ...
                this.jobAreas.map((item) => {
                    this.addSkillsForm.controls.jobAreas.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormControl"]());
                });
            }
        }, (error) => {
        ...
        this.masterService.getSkills().subscribe((res) => {
            if (!res.error) {
                ...
                this.skills.map((item) => {
                    this.addSkillsForm.controls.skills.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormControl"]());
                });
            }
        }, (error) => {
            ...
            if (this.cachedData.selected_skills) {
                ...
                this.skills.map((item) => {
                    ...
                    if (skillsArr.includes(item.id)) {
                        this.addSkillsForm.controls.skills.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormControl"](true));
                    }
                    else {
                        this.addSkillsForm.controls.skills.push(new _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormControl"]());
                    }
...
ProfessionalProfilePage.ctorParameters = () => [
...
ProfessionalProfilePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-professional-profile',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./professional-profile.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/signup/professional-profile/professional-profile.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./professional-profile.page.scss */ "./src/app/signup/professional-profile/professional-profile.page.scss")).default]
    }),
...
//# sourceMappingURL=signup-professional-profile-professional-profile-module-es2015.js.map