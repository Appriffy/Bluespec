...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~profile-user-profile-module~user-profile-user-profile-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserProfileChangeProfileDescriptionChangeProfileDescriptionModalHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserProfileChangeProfileStatusChangeProfileStatusModalHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserWorkReviewsWorkReviewWorkReviewComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDbmodelsWorkReviewModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WorkReviewModel", function () {
    ...
    function (_shell_data_store__WE) {
      _inherits(WorkReviewModel, _shell_data_store__WE);

      function WorkReviewModel() {
        _classCallCheck(this, WorkReviewModel);

        return _possibleConstructorReturn(this, _getPrototypeOf(WorkReviewModel).apply(this, arguments));
      }
  ...
  /***/
  function srcAppUserProfileChangeProfileDescriptionChangeProfileDescriptionModalTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ChangeProfileDescriptionModal", function () {
      return ChangeProfileDescriptionModal;
    });
    /* harmony import */
    ...
    var ChangeProfileDescriptionModal =
    /*#__PURE__*/
    function () {
      function ChangeProfileDescriptionModal(modalController, firebaseService, authService, toastService, alertController, loadingController, router) {
        _classCallCheck(this, ChangeProfileDescriptionModal);
        ...
        this.validations = {
          'description': [{
            type: 'required',
            message: 'Write a short intro about you.'
          }, {
            type: 'minLength',
            message: 'Your Intro appears to be too small.'
          }, {
            type: 'maxLength',
            message: 'Intro should not exceed 100 characters.'
          }]
        };
      }

      _createClass(ChangeProfileDescriptionModal, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.authService.getAuthCache().then(function (promisedValue) {
            _this.localUser = promisedValue; //this.userImage = this.image;
          });
        }
      }, {
        key: "dismissModal",
        ...
        value: function createUser() {
          ...
          this.firebaseService.callUpdateProfileDescriptionAPI(this.localUser.api_key, postData).subscribe(function (event) {
            _this2.loadingController.dismiss();

            if (!event.error) {
              _this2.dismissModal();

              _this2.toastService.presentToast(event.message);
            } else {
              _this2.presentAlert(event.message);
            }
          }, function (error) {
            _this2.loadingController.dismiss();
    ...
    ChangeProfileDescriptionModal.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Number)], ChangeProfileDescriptionModal.prototype, "userID", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)], ChangeProfileDescriptionModal.prototype, "description", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)], ChangeProfileDescriptionModal.prototype, "image", void 0);
    ChangeProfileDescriptionModal = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-change-profile-description',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./change-profile-description.modal.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user/profile/change-profile-description/change-profile-description.modal.html")).default,
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"], _services_toast_service__WEBPACK_IMPORTED_MODULE_7__["ToastService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], ChangeProfileDescriptionModal);
    /***/
  },
  ...
  /***/
  function srcAppUserProfileChangeProfileStatusChangeProfileStatusModalTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ChangeProfileStatusModal", function () {
      return ChangeProfileStatusModal;
    });
    /* harmony import */
    ...
    var _user_profile_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../user-profile.model */
    "./src/app/user/profile/user-profile.model.ts");

    var ChangeProfileStatusModal =
    /*#__PURE__*/
    function () {
      function ChangeProfileStatusModal(modalController, firebaseService, authService, toastService, alertController, loadingController, router) {
        _classCallCheck(this, ChangeProfileStatusModal);
        ...
        this.validations = {
          'tagline': [{
            type: 'required',
            message: 'Write a tagline for your profile.'
          }, {
            type: 'minLength',
            message: 'Your tagline appears to be too small.'
          }, {
            type: 'maxLength',
            message: 'Tagline should not exceed 30 characters.'
          }]
        };
      }

      _createClass(ChangeProfileStatusModal, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this3 = this;
          ...
          this.authService.getAuthCache().then(function (promisedValue) {
            _this3.localUser = promisedValue; //this.updateStatusForm.patchValue({user_id:this.localUser.id});
          });
        }
      }, {
        key: "dismissModal",
        ...
        value: function createUser() {
          ...
          this.firebaseService.callUpdateProfileStatusAPI(this.localUser.api_key, postData).subscribe(function (event) {
            _this4.loadingController.dismiss();

            if (!event.error) {
              _this4.dismissModal();

              _this4.toastService.presentToast(event.message); //this.router.navigate(['/people/details', event.username]);
    ...
    ChangeProfileStatusModal.ctorParameters = function () {
      return [{
        type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"]
      }, {
        type: _user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"]
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Number)], ChangeProfileStatusModal.prototype, "userID", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)], ChangeProfileStatusModal.prototype, "tagline", void 0);
    ChangeProfileStatusModal = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-change-profile-status',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./change-profile-status.modal.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user/profile/change-profile-status/change-profile-status.modal.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./styles/change-profile-status.scss */
      "./src/app/user/profile/change-profile-status/styles/change-profile-status.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./styles/change-profile-status.shell.scss */
      "./src/app/user/profile/change-profile-status/styles/change-profile-status.shell.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"], _services_toast_service__WEBPACK_IMPORTED_MODULE_7__["ToastService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], ChangeProfileStatusModal);
    /***/
  },
  ...
  /***/
  function srcAppUserProfileChangeProfileStatusStylesChangeProfileStatusScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserProfileChangeProfileStatusStylesChangeProfileStatusShellScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppUserProfileUserProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _change_profile_status_change_profile_status_modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./change-profile-status/change-profile-status.modal */
    "./src/app/user/profile/change-profile-status/change-profile-status.modal.ts");
    /* harmony import */


    var _work_reviews_work_review_work_review_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../work-reviews/work-review/work-review.module */
    "./src/app/user/work-reviews/work-review/work-review.module.ts");
    /* harmony import */


    var _change_profile_description_change_profile_description_modal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./change-profile-description/change-profile-description.modal */
    "./src/app/user/profile/change-profile-description/change-profile-description.modal.ts");
    ...
    UserProfilePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_9__["ComponentsModule"], _work_reviews_work_review_work_review_module__WEBPACK_IMPORTED_MODULE_11__["WorkReviewModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
  ...
  function srcAppUserProfileUserProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _education_details_create_create_education_details_modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../education-details/create/create-education-details.modal */
    ...
    var _change_profile_description_change_profile_description_modal__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./change-profile-description/change-profile-description.modal */
    "./src/app/user/profile/change-profile-description/change-profile-description.modal.ts");
    ...
    /*#__PURE__*/
    function () {
      function UserProfilePage(route, ngRouter, menu, toastService, alertController, modalController, authService, storageService) {
        ...
        this.loading = true; //localUser : any;
      ...
      _createClass(UserProfilePage, [{
                  ...
                  case 0:
                    this.authService.getAuthCache().then(function (promisedValue) {
                      if (promisedValue) {
                        ...
                        _this5.user_profile_id = _this5.localUser.user_name;
                        console.log("/***** PROFILE PAGE LOCAL USER : " + JSON.stringify(promisedValue));
                        /************ CHECK ROUTE PARAM REQUESTS ***************/

                        _this5.route.paramMap.subscribe(function (params) {
                          if (params.get("user_id")) {
                            _this5.user_profile_id = params.get("user_id");

                            if (_this5.user_profile_id != _this5.localUser.user_name) {
                              _this5.selfView = false;
                            }

                            if (_this5.localUser.role_id === 1) {
                              _this5.adminMode = true;
                            } // alert("YYY"+this.localUser.role_id);

                          }

                          _this5.hitProfileAPI();
                        });
                        /************ CHECK ROUTE PARAM REQUESTS ***************/

                      } else {
                        _this5.toastService.presentToast("Looks like you are not logged in.");
        ...
        key: "hitProfileAPI",
        value: function hitProfileAPI() {
          if (navigator.onLine) {
            this.refreshFullProfile();
          }
        }
      }, {
        key: "refreshFullProfile",
        value: function refreshFullProfile() {
          var _this6 = this;
          ...
          this.authService.getAuthCache().then(function (authData) {
            if (authData) {
              var postData = {
                'user_id': _this6.user_profile_id
              };

              _this6.authService.getFullProfileFromServer(authData.api_key, postData).subscribe(function (res) {
                if (!res.error) {
                  if (_config_AuthConstants__WEBPACK_IMPORTED_MODULE_5__["AuthConstants"].DEV_MODE) {
                    console.log("PROFILE SYNC :: " + JSON.stringify(res));
                  }

                  _this6.profile = res.myProfile;
                  _this6.loading = false;
                } else {
                  _this6.toastService.presentToast(res.message);
                }
              }, function (error) {
                _this6.toastService.presentToast('Looks like there is a Network Issue while fetching profile.');
              });
            }
          });
        }
        ...
        key: "addNewEducationItem",
        value: function addNewEducationItem() {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
        ...
        value: function openStatusDialog() {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
                ...
                switch (_context8.prev = _context8.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (item) {
                      if (item.data != null) {
                        _this7.profile.tagline = item.data;

                        _this7.refreshFullProfile();
                      }
                    });
                    _context8.next = 6;
                    return modal.present();
        ...
        key: "openProfileDescDialog",
        value: function openProfileDescDialog() {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
              ...
              while (1) {
                switch (_context9.prev = _context9.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (item) {
                      if (item.data != null) {
                        _this8.profile.description = item.data;

                        _this8.refreshFullProfile();
                      }
                    });
                    _context9.next = 6;
                    return modal.present();
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["MenuController"], _services_toast_service__WEBPACK_IMPORTED_MODULE_7__["ToastService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"], _services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"], _services_storage_service__WEBPACK_IMPORTED_MODULE_4__["StorageService"]])], UserProfilePage);
    /***/
  },
  ...
  function srcAppUserProfileUserProfileResolverTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function UserProfileResolver(userService, storageService, authService) {
      ...
      _createClass(UserProfileResolver, [{
        ...
        value: function resolve(route) {
          ...
          regeneratorRuntime.mark(function _callee10() {
            var authDataVal, user_id, apiKey, dataSource, dataStore;
            return regeneratorRuntime.wrap(function _callee10$(_context10) {
              while (1) {
                switch (_context10.prev = _context10.next) {
                  case 0:
                    _context10.next = 2;
                    return this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_3__["AuthConstants"].AUTH);

                  case 2:
                    authDataVal = _context10.sent;
                    //console.log("JobApplicationsManagerResolver authDataVal => "+JSON.stringify(authDataVal));
                    user_id = route.params['user_id'];
                    apiKey = authDataVal.api_key;
                    dataSource = this.userService.getProfileDataSource(apiKey, user_id);
                    dataStore = this.userService.getProfileStore(dataSource);
                    return _context10.abrupt("return", dataStore);
    ...
    UserProfileResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _services_storage_service__WEBPACK_IMPORTED_MODULE_4__["StorageService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"]])], UserProfileResolver);
    /***/
  },
  ...
  /***/
  function srcAppUserWorkReviewsWorkReviewWorkReviewComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserWorkReviewsWorkReviewWorkReviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WorkReviewComponent", function () {
      return WorkReviewComponent;
    });
    /* harmony import */
    ...
    var _dbmodels_work_review_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../../dbmodels/work-review-model */
    "./src/app/dbmodels/work-review-model.ts");

    var WorkReviewComponent =
    /*#__PURE__*/
    function () {
      function WorkReviewComponent() {
        _classCallCheck(this, WorkReviewComponent);

        this.adminMode = false;
      }

      _createClass(WorkReviewComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {// console.log("Inside Review Component => "+JSON.stringify(this.review));
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('review'), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _dbmodels_work_review_model__WEBPACK_IMPORTED_MODULE_2__["WorkReviewModel"])], WorkReviewComponent.prototype, "review", void 0);
    WorkReviewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-work-review',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./work-review.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user/work-reviews/work-review/work-review.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      ...
      "./src/app/user/work-reviews/work-review/work-review.component.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], WorkReviewComponent);
    /***/
  },
  ...
  /***/
  function srcAppUserWorkReviewsWorkReviewWorkReviewModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WorkReviewModule", function () {
      return WorkReviewModule;
    });
    /* harmony import */
    ...
    var _work_review_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./work-review.component */
    "./src/app/user/work-reviews/work-review/work-review.component.ts");
    /* harmony import */
    ...
    /*! ../../../components/components.module */
    "./src/app/components/components.module.ts"); //import { ShellModule } from '../../../shell/shell.module';


    var WorkReviewModule = function WorkReviewModule() {
      _classCallCheck(this, WorkReviewModule);
    };

    WorkReviewModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_6__["ComponentsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot()],
      declarations: [_work_review_component__WEBPACK_IMPORTED_MODULE_5__["WorkReviewComponent"]],
      exports: [_work_review_component__WEBPACK_IMPORTED_MODULE_5__["WorkReviewComponent"]]
    })], WorkReviewModule);
    /***/
  }
}]);
//# sourceMappingURL=default~profile-user-profile-module~user-profile-user-profile-module-es5.js.map