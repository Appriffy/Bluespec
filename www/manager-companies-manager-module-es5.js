...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["manager-companies-manager-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCompaniesManagerCompaniesManagerPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCompaniesManagerCompaniesManagerModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CompaniesManagerPageModule", function () {
      return CompaniesManagerPageModule;
    });
    /* harmony import */
    ...
    var _companies_resolver__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../companies.resolver */
    ...
    var _companies_manager_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var CompaniesManagerPageModule = function CompaniesManagerPageModule() {
      _classCallCheck(this, CompaniesManagerPageModule);
    };

    CompaniesManagerPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_8__["ComponentsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes)],
      declarations: [_companies_manager_page__WEBPACK_IMPORTED_MODULE_9__["CompaniesManagerPage"]],
      providers: [_companies_resolver__WEBPACK_IMPORTED_MODULE_6__["CompanyListingResolver"], _companies_service__WEBPACK_IMPORTED_MODULE_7__["CompanyService"]],
      entryComponents: []
  ...
  /***/
  function srcAppCompaniesManagerCompaniesManagerPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CompaniesManagerPage", function () {
      return CompaniesManagerPage;
    });
    /* harmony import */
    ...
    var CompaniesManagerPage =
    /*#__PURE__*/
    function () {
      function CompaniesManagerPage(companyService, route, ngRouter, toastService, authService, storageService, modalController) {
        _classCallCheck(this, CompaniesManagerPage);
      ...
      _createClass(CompaniesManagerPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.getAuthCache().then(function (promisedValue) {
            ...
            if (_config_AuthConstants__WEBPACK_IMPORTED_MODULE_7__["AuthConstants"].DEV_MODE) {
              console.log("Local User: " + _this.localUser.id);
            }
          });
          this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_7__["AuthConstants"].MY_COMPANIES).then(function (companies) {
            if (companies) {
        ...
        value: function fetchFreshList(showLoading) {
          ...
          this.authService.getAuthCache().then(function (results) {
            if (results) {
              _this2.companyService.getMyCompanies(results.api_key, {}).subscribe(function (res) {
                ...
                if (res.error) {
                  ...
                  _this2.listing = res.items;
                  _this2.loading = false;

                  _this2.storageService.store(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_7__["AuthConstants"].MY_COMPANIES, res.items);
                }
              }, function (error) {
    ...
    CompaniesManagerPage.ctorParameters = function () {
      return [{
    ...
    CompaniesManagerPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-companies-manager',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./companies-manager.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/companies/manager/companies-manager.page.html")).default,
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_companies_service__WEBPACK_IMPORTED_MODULE_4__["CompanyService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _services_toast_service__WEBPACK_IMPORTED_MODULE_6__["ToastService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"], _services_storage_service__WEBPACK_IMPORTED_MODULE_9__["StorageService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"]])], CompaniesManagerPage);
    /***/
  }
}]);
//# sourceMappingURL=manager-companies-manager-module-es5.js.map