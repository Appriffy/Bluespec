...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bluspec-recruiter-bluspec-recruiter-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppBluspecRecruiterBluspecRecruiterPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppBluspecRecruiterBluspecRecruiterModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BluspecRecuiterPageModule", function () {
      return BluspecRecuiterPageModule;
    });
    /* harmony import */
    ...
    var _bluspec_recruiter_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./bluspec-recruiter.page */
    "./src/app/bluspec-recruiter/bluspec-recruiter.page.ts");
    /* harmony import */


    var _location_autocomplete_location_autocomplete_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./location-autocomplete/location-autocomplete.page */
    ...
    var BluspecRecuiterPageModule = function BluspecRecuiterPageModule() {
      _classCallCheck(this, BluspecRecuiterPageModule);
    };

    BluspecRecuiterPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppBluspecRecruiterBluspecRecruiterPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BluspecRecuiterPage", function () {
      return BluspecRecuiterPage;
    });
    /* harmony import */
    ...
    var BluspecRecuiterPage =
    /*#__PURE__*/
    function () {
      function BluspecRecuiterPage(menu, loadingController, alertController, modalCtrl, masterService, toaster) {
        _classCallCheck(this, BluspecRecuiterPage);
      ...
      _createClass(BluspecRecuiterPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.masterService.getSkills().subscribe(function (res) {
            if (!res.error) {
              ...
              _this.jobSkillsArr = res.result;

              _this.jobSkillsArr.map(function (item) {// (this.gettingStartedForm.controls.skills as FormArray).push(new FormControl());
        ...
        value: function loadCurrentLocation() {
          ...
          this.displayLoader().then(function (loader) {
            // get position
            return _this3.getCurrentPosition().then(function (position) {
              ...
              _this3.toaster.presentToast("Current Location: " + position.coords.latitude + ", " + position.coords.longitude); //alert(position.coords.latitude+", "+ position.coords.longitude); 
              //this.currentLat = position.coords.latitude;
              //this.currentLong = position.coords.longitude;


              _this3.gettingStartedForm.controls.latitude.setValue(position.coords.latitude);

              _this3.gettingStartedForm.controls.longitude.setValue(position.coords.longitude); // fermer loader + return position
            ...
            return position instanceof Error ? _this3.presentAlert(position.message) : null;
          }) // do not forget to handle promise rejection
          .catch(function (err) {
            _this3.presentAlert(err.message);
          });
        }
      }, {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return _context2.abrupt("return", Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(new Error('Err: plugin not available')));
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 2:
                    this.loadingElement = _context3.sent;
        ...
        value: function geolocateMe() {
          ...
          Geolocation.getCurrentPosition().then(function (position) {
            ...
            _this4.map.panTo(current_location); // add a marker
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        _this5.dataReturned = dataReturned;
                        console.log("dataReturned.data: " + dataReturned.data);
                        alert('Modal Sent Data :' + dataReturned.data);
                        _this5.address.place = "Geolocation to be integreted"; //alert('Modal Sent Data :'+ dataReturned.data.address);
                      } else {
                        alert('Modal did not sent data');
                        _this5.address.place = "Location to be integreted";
                      }
                    });
                    _context6.next = 6;
            ...
            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  ...
                  case 5:
                    return _context7.abrupt("return", alert);
    ...
    BluspecRecuiterPage.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_components_google_map_google_map_component__WEBPACK_IMPORTED_MODULE_6__["GoogleMapComponent"], {
      static: true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _components_google_map_google_map_component__WEBPACK_IMPORTED_MODULE_6__["GoogleMapComponent"])], BluspecRecuiterPage.prototype, "_GoogleMap", void 0);
    BluspecRecuiterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-recuiter',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./bluspec-recruiter.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/bluspec-recruiter/bluspec-recruiter.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./styles/getting-started.page.scss */
      "./src/app/bluspec-recruiter/styles/getting-started.page.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./styles/getting-started.shell.scss */
      "./src/app/bluspec-recruiter/styles/getting-started.shell.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./styles/getting-started.responsive.scss */
      "./src/app/bluspec-recruiter/styles/getting-started.responsive.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["MenuController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"], _services_master_service__WEBPACK_IMPORTED_MODULE_9__["MasterService"], _services_toast_service__WEBPACK_IMPORTED_MODULE_7__["ToastService"]])], BluspecRecuiterPage);
    /***/
  },
  ...
  /***/
  function srcAppBluspecRecruiterStylesGettingStartedPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppBluspecRecruiterStylesGettingStartedResponsiveScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppBluspecRecruiterStylesGettingStartedShellScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
...
//# sourceMappingURL=bluspec-recruiter-bluspec-recruiter-module-es5.js.map