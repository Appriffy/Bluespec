...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[38], {
  ...
  function node_modulesIonicCoreDistEsmIonMenu_4IosEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(Menu, [{
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return regeneratorRuntime.awrap(this.lazyMenuCtrl.componentOnReady().then(function (p) {
        ...
        value: function _setOpen(shouldOpen) {
          var animated,
              _args2 = arguments;
          return regeneratorRuntime.async(function _setOpen$(_context2) {
            while (1) {
        ...
        value: function loadAnimation() {
          var width;
          return regeneratorRuntime.async(function loadAnimation$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 3:
                  ...
                  _context3.next = 7;
                  return regeneratorRuntime.awrap(this.menuCtrl._createAnimation(this.type, this));
        ...
        value: function startAnimation(shouldOpen, animated) {
          var ani;
          return regeneratorRuntime.async(function startAnimation$(_context4) {
            while (1) {
    ...
    var toggleMenu = function toggleMenu(menu) {
      var menuCtrl, menuEl;
      return regeneratorRuntime.async(function toggleMenu$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return regeneratorRuntime.awrap(getMenuController(document));
            ...
            case 2:
              ...
              _context5.next = 6;
              return regeneratorRuntime.awrap(menuCtrl.get(menu));
    ...
    function () {
      function MenuButton(hostRef) {
        ...
        this.setVisibility = function _callee() {
          return regeneratorRuntime.async(function _callee$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  _context7.next = 2;
                  return regeneratorRuntime.awrap(updateVisibility(_this4.menu));
        ...
        this.onClick = function _callee2() {
          return regeneratorRuntime.async(function _callee2$(_context8) {
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  _context8.next = 2;
                  return regeneratorRuntime.awrap(toggleMenu(_this4.menu));
      ...
      _createClass(MenuButton, [{
          ...
          return regeneratorRuntime.async(function componentDidLoad$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  _context9.next = 2;
                  return regeneratorRuntime.awrap(this.setVisibility());
        ...
        value: function render() {
          ...
          return Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["H"], {
            ...
            class: Object.assign(_defineProperty({}, mode, true), Object(_chunk_353a032e_js__WEBPACK_IMPORTED_MODULE_2__["c"])(color), {
              'button': true,
    ...
    function () {
      ...
      _createClass(MenuController, [{
        ...
        value: function open(menu) {
          var menuEl;
          return regeneratorRuntime.async(function open$(_context11) {
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  _context11.next = 2;
                  return regeneratorRuntime.awrap(this.get(menu));
        ...
        value: function close(menu) {
          var menuEl;
          return regeneratorRuntime.async(function close$(_context12) {
            while (1) {
              switch (_context12.prev = _context12.next) {
                case 0:
                  _context12.next = 2;
                  return regeneratorRuntime.awrap(menu !== undefined ? this.get(menu) : this.getOpen());
        ...
        value: function toggle(menu) {
          var menuEl;
          return regeneratorRuntime.async(function toggle$(_context13) {
            while (1) {
        ...
        value: function enable(_enable, menu) {
          var menuEl;
          return regeneratorRuntime.async(function enable$(_context14) {
            while (1) {
        ...
        value: function swipeGesture(enable, menu) {
          var menuEl;
          return regeneratorRuntime.async(function swipeGesture$(_context15) {
            while (1) {
        ...
        value: function isOpen(menu) {
          ...
          return regeneratorRuntime.async(function isOpen$(_context16) {
            while (1) {
              switch (_context16.prev = _context16.next) {
                ...
                case 7:
                  _context16.next = 9;
                  return regeneratorRuntime.awrap(this.getOpen());
        ...
        value: function isEnabled(menu) {
          var menuEl;
          return regeneratorRuntime.async(function isEnabled$(_context17) {
            while (1) {
        ...
        value: function get(menu) {
          var menuRef, menuEl;
          return regeneratorRuntime.async(function get$(_context18) {
            while (1) {
              switch (_context18.prev = _context18.next) {
                case 0:
                  _context18.next = 2;
                  return regeneratorRuntime.awrap(this.waitUntilReady());
        ...
        value: function getOpen() {
          return regeneratorRuntime.async(function getOpen$(_context19) {
            while (1) {
        ...
        value: function getMenus() {
          return regeneratorRuntime.async(function getMenus$(_context20) {
            while (1) {
        ...
        value: function isAnimating() {
          return regeneratorRuntime.async(function isAnimating$(_context21) {
            while (1) {
        ...
        value: function registerAnimation(name, animation) {
          return regeneratorRuntime.async(function registerAnimation$(_context22) {
            while (1) {
        ...
        value: function _setOpen(menu, shouldOpen, animated) {
          var openedMenu;
          return regeneratorRuntime.async(function _setOpen$(_context23) {
            while (1) {
        ...
        value: function _createAnimation(type, menuCmp) {
          ...
          return regeneratorRuntime.async(function _createAnimation$(_context24) {
            while (1) {
    ...
    function () {
      function MenuToggle(hostRef) {
        ...
        this.setVisibility = function _callee3() {
          return regeneratorRuntime.async(function _callee3$(_context25) {
            while (1) {
              switch (_context25.prev = _context25.next) {
                case 0:
                  _context25.next = 2;
                  return regeneratorRuntime.awrap(updateVisibility(_this5.menu));
        ...
        this.onClick = function _callee4() {
          return regeneratorRuntime.async(function _callee4$(_context26) {
            while (1) {
              switch (_context26.prev = _context26.next) {
                case 0:
                  _context26.next = 2;
                  return regeneratorRuntime.awrap(toggleMenu(_this5.menu));
      ...
      _createClass(MenuToggle, [{
        key: "componentDidLoad",
        value: function componentDidLoad() {
          return regeneratorRuntime.async(function componentDidLoad$(_context27) {
            while (1) {
        ...
        key: "visibilityChanged",
        value: function visibilityChanged() {
          return regeneratorRuntime.async(function visibilityChanged$(_context28) {
            while (1) {
