...
/* harmony import */ var _summary_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./summary.page */ "./src/app/dashboard/summary/summary.page.ts");
...
let SummaryPage = class SummaryPage {
    ...
    ngOnInit() {
        ...
        this.storageService
            .get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_8__["AuthConstants"].DASHBOARD_SUMMARY_CACHE)
            .then(res => {
            if (res) {
    ...
    getDataSummaryForDashboard() {
        ...
        this.authService.getAuthKey().then(apiKey => {
            this.firebaseService.fetchMyDashboard(apiKey)
                ...
                //this.storageService.store(AuthConstants.DASHBOARD_SUMMARY_CACHE, JSON.stringify(res.items));
                this.storageService.store(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_8__["AuthConstants"].DASHBOARD_SUMMARY_CACHE, res.items);
...
SummaryPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./summary.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dashboard/summary/summary.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./summary.page.scss */ "./src/app/dashboard/summary/summary.page.scss")).default]
    }),
...
//# sourceMappingURL=dashboard-summary-summary-module-es2015.js.map