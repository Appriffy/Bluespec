...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobApplicationModel", function() { return JobApplicationModel; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobApplicationsManagerPageModule", function() { return JobApplicationsManagerPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _manager_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./manager.page */ "./src/app/jobs/job-applications-manager/manager.page.ts");
/* harmony import */ var _jobs_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../jobs.service */ "./src/app/jobs/jobs.service.ts");
/* harmony import */ var _components_components_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../components/components.module */ "./src/app/components/components.module.ts");
/* harmony import */ var _manager_resolver__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./manager.resolver */ "./src/app/jobs/job-applications-manager/manager.resolver.ts");
/* harmony import */ var _view_job_application_view_job_application_modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./view-job-application/view-job-application.modal */ "./src/app/jobs/job-applications-manager/view-job-application/view-job-application.modal.ts");
...
let JobApplicationsManagerPageModule = class JobApplicationsManagerPageModule {
};
JobApplicationsManagerPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            _manager_resolver__WEBPACK_IMPORTED_MODULE_9__["JobApplicationsManagerResolver"],
            _jobs_service__WEBPACK_IMPORTED_MODULE_7__["JobService"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobApplicationsManagerPage", function() { return JobApplicationsManagerPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _view_job_application_view_job_application_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view-job-application/view-job-application.modal */ "./src/app/jobs/job-applications-manager/view-job-application/view-job-application.modal.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/auth.service */ "./src/app/services/auth.service.ts");
/* harmony import */ var _jobs_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../jobs.service */ "./src/app/jobs/jobs.service.ts");
...
let JobApplicationsManagerPage = class JobApplicationsManagerPage {
    // @HostBinding('class.is-shell') get isShell() {
    //   return (this.data && this.data.isShell) ? true : false;
    // }
    constructor(route, ngRouter, authService, jobService, modalController) {
        this.route = route;
    ...
    openJobApplicationDialog(jobApplication) {
...
JobApplicationsManagerPage.ctorParameters = () => [
...
JobApplicationsManagerPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-manager',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./manager.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/jobs/job-applications-manager/manager.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/job-tabs.page.scss */ "./src/app/jobs/job-applications-manager/styles/job-tabs.page.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/job-tabs.shell.scss */ "./src/app/jobs/job-applications-manager/styles/job-tabs.shell.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/job-tabs.md.scss */ "./src/app/jobs/job-applications-manager/styles/job-tabs.md.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"],
        _jobs_service__WEBPACK_IMPORTED_MODULE_6__["JobService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"]])
], JobApplicationsManagerPage);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobApplicationsManagerResolver", function() { return JobApplicationsManagerResolver; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let JobApplicationsManagerResolver = class JobApplicationsManagerResolver {
    ...
    resolve(route) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let authDataVal = yield this.storageService.get(_config_AuthConstants__WEBPACK_IMPORTED_MODULE_4__["AuthConstants"].AUTH);
            //console.log("JobApplicationsManagerResolver authDataVal => "+JSON.stringify(authDataVal));
            let jobCode = route.params['job_code'];
            let apiKey = authDataVal.api_key;
            //console.log("JobApplicationsManagerResolver apiKey => "+apiKey);
            let postData = { job_id: jobCode };
            const dataSource = this.userService.getJobApplicationsManagerDataSource(apiKey, postData);
            const dataStore = this.userService.getJobApplicationsManagerStore(dataSource);
            return dataStore;
        });
    }
};
JobApplicationsManagerResolver.ctorParameters = () => [
    { type: _jobs_service__WEBPACK_IMPORTED_MODULE_2__["JobService"] },
    { type: _services_storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"] },
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }
];
JobApplicationsManagerResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_jobs_service__WEBPACK_IMPORTED_MODULE_2__["JobService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewJobApplicationModal", function() { return ViewJobApplicationModal; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _dbmodels_job_application_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../dbmodels/job-application.model */ "./src/app/dbmodels/job-application.model.ts");
/* harmony import */ var _jobs_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../jobs.service */ "./src/app/jobs/jobs.service.ts");
...
let ViewJobApplicationModal = class ViewJobApplicationModal {
...
ViewJobApplicationModal.ctorParameters = () => [
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _dbmodels_job_application_model__WEBPACK_IMPORTED_MODULE_7__["JobApplicationModel"])
], ViewJobApplicationModal.prototype, "jobApplication", void 0);
ViewJobApplicationModal = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-view-job-application',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./view-job-application.modal.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/jobs/job-applications-manager/view-job-application/view-job-application.modal.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ../../../bluspecstyles/filter.page.scss */ "./src/app/bluspecstyles/filter.page.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/view-job-application.scss */ "./src/app/jobs/job-applications-manager/view-job-application/styles/view-job-application.scss")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./styles/view-job-application.shell.scss */ "./src/app/jobs/job-applications-manager/view-job-application/styles/view-job-application.shell.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
        _jobs_service__WEBPACK_IMPORTED_MODULE_8__["JobService"],
        _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"],
...
//# sourceMappingURL=job-applications-manager-manager-module-es2015.js.map